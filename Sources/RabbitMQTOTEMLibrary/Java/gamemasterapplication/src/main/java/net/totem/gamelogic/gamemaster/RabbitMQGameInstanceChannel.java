...
class RabbitMQGameInstanceChannel {
	...
	RabbitMQGameInstanceChannel(final ChannelsManager channelsManager, final GameMasterState state) throws java.io.IOException {
		this.channelsManager = channelsManager;
		initCommunicationWithBroker(state);
	}
	

	protected boolean initCommunicationWithBroker(final GameMasterState state){
	...
	private void handleRetryNumber(int retryNumber, int maxRetryNumber, final GameMasterState state){
	...
	private void updateNumberOfRetries(int retryNumber, final GameMasterState state){
		synchronized (state) {
