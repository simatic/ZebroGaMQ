...
public enum LifeCycleAction implements GameMasterActionInterface {
	INITIATE_TERMINATTION("terminate") {
		public Object execute(final GameMasterState state, final String[] header,
				final String body) throws ActionInvocationException {
			return GameMasterProtocol.terminate(state, header, body);
		}
	};
