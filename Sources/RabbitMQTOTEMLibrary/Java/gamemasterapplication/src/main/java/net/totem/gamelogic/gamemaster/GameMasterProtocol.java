...
public class GameMasterProtocol{

	public static Object terminate(final GameMasterState state,
	...
	public static Object joinMaster(final GameMasterState state,
			final String[] header, final String body) {
		if (state == null) {
			throw new IllegalArgumentException(
		...
		Util.println(" [Master " + state.login + "] Received "
				+ Arrays.asList(header) + " / " + body);
		return null;
	}

	public static Object joinMasterOK(final GameMasterState state,
			final String[] header, final String body) {
		if (state == null) {
			throw new IllegalArgumentException(
	...
	public static Object joinSpectator(final GameMasterState state,
			final String[] header, final String body) {
		if (state == null) {
			throw new IllegalArgumentException(
	...
	public static Object joinSpectatorOK(final GameMasterState state,
			final String[] header, final String body) {
		if (state == null) {
			throw new IllegalArgumentException(
	...
	public static Object joinPlayer(final GameMasterState state,
			final String[] header, final String body) {
		if (state == null) {
			throw new IllegalArgumentException(
	...
	public static Object joinPlayerOK(final GameMasterState state,
			final String[] header, final String body) {
		if (state == null) {
			throw new IllegalArgumentException(
	...
	public static Object participantsList(final GameMasterState state,
			final String[] header, final String body) {
		if (state == null) {
			throw new IllegalArgumentException(
		...
		if (header == null) {
			throw new IllegalArgumentException(
					"participantsList action with null header message");
		}
		if (body == null) {
			throw new IllegalArgumentException(
