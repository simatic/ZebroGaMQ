...
public enum JoinAction implements SpectatorActionInterface {
	JOIN_MASTER("joinMaster") {
		public Object execute(final SpectatorState state,
			...
			return SpectatorProtocol.joinMaster(state, header, body);
		}
	},
	JOIN_MASTER_OK("joinMasterOK") {
		public Object execute(final SpectatorState state,
				final String[] header, final String body)
				throws ActionInvocationException {
			return SpectatorProtocol.joinMasterOK(state, header, body);
		}
	},
	JOIN_SPECTATOR("joinSpectator") {
		public Object execute(final SpectatorState state,
				final String[] header, final String body)
				throws ActionInvocationException {
			return SpectatorProtocol.joinSpectator(state, header, body);
		}
	},
	JOIN_SPECTATOR_OK("joinSpectatorOK") {
		public Object execute(final SpectatorState state,
				final String[] header, final String body)
				throws ActionInvocationException {
			return SpectatorProtocol.joinSpectatorOK(state, header, body);
		}
	},
	JOIN_PLAYER("joinPlayer") {
		public Object execute(final SpectatorState state,
				final String[] header, final String body)
				throws ActionInvocationException {
			return SpectatorProtocol.joinPlayer(state, header, body);
		}
	},
	JOIN_PLAYER_OK("joinPlayerOK") {
		public Object execute(final SpectatorState state,
				final String[] header, final String body)
				throws ActionInvocationException {
			return SpectatorProtocol.joinPlayerOK(state, header, body);
		}
	};
