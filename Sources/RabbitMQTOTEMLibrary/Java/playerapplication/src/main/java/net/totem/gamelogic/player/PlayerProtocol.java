...
public class PlayerProtocol{
	...
	public static Object terminate(final PlayerState state,
	...
	public static Object joinMaster(final PlayerState state,
			final String[] header, final String body) {
		if (state == null) {
			throw new IllegalArgumentException(
		...
		Util.println(" [Player " + state.login + "] Received "
				+ Arrays.asList(header) + " / " + body);
		return null;
	}

	public static Object joinMasterOK(final PlayerState state,
			final String[] header, final String body) {
		if (state == null) {
			throw new IllegalArgumentException(
	...
	public static Object joinSpectator(final PlayerState state,
			final String[] header, final String body) {
		if (state == null) {
			throw new IllegalArgumentException(
	...
	public static Object joinSpectatorOK(final PlayerState state,
			final String[] header, final String body) {
		if (state == null) {
			throw new IllegalArgumentException(
	...
	public static Object joinPlayer(final PlayerState state,
			final String[] header, final String body) {
		if (state == null) {
			throw new IllegalArgumentException(
	...
	public static Object joinPlayerOK(final PlayerState state,
			final String[] header, final String body) {
		if (state == null) {
			throw new IllegalArgumentException(
	...
	public static Object participantsList(final PlayerState state,
			final String[] header, final String body) {
		if (state == null) {
			throw new IllegalArgumentException(
