...
public class HeartbeatChannel extends PublishChannel{
	...
	HeartbeatChannel(final ChannelsManager channelsManager, final PlayerState state) throws IOException {
	...
	private long loadHeartbeatPeriod(final PlayerState state){
		long period = 0;
		try {
	...
	private void startHeartbeatThread(final PlayerState state, final long heartbeatPeriod){
