...
public class ChannelsManager {
	 ...
	 * @param loai	the list of PlayerAction 
	 ...
	 */
	public static ChannelsManager getInstance(	final PlayerState state,
	 ...
	 * Instantiate the ChannelsManager, required for the consumption and the publication of messages.
	 * As soon as this method is called, the consumption of messages is automatically started.
	 * If the action kind and the action name of the messages consumed are not registered in the list of PlayerAction,
	...
	private ChannelsManager(final PlayerState state,
							final List<Map<String, ? extends PlayerActionInterface>> loai,
							boolean enableRawAction)
							throws IOException {
		// initialize state
	...
	private ConnectionFactory getConnectionFactory(final PlayerState state){
	...
	void exit() {
		Util.println(" [Player] exiting: closing channels and connections");
	 ...
	 */
	public void publish(final String consumer, final PlayerState state,
						final PlayerActionInterface action, final String message)
	 ...
	 * 			The method PlayerState.exit() should be called on the handling of this exception.
	 */
	public void publishToAll(	final PlayerState state,
								final PlayerActionInterface action, final String message)
								throws IOException {
	 ...
	 * 			The method PlayerState.exit() should be called on the handling of this exception.
	 */
	public void publishToGameLogicServer(	final PlayerState state,
											final PlayerActionInterface action, final String message)
											throws IOException, MissedHeartbeatException {
