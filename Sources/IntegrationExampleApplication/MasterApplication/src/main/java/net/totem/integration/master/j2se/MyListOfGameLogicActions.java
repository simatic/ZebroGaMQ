...
public enum MyListOfGameLogicActions {
	...
	private Map<String, ? extends GameMasterActionInterface> actionMap;
	private static List<Map<String, ? extends GameMasterActionInterface>> privateListOfActionsMaps = new Vector<Map<String, ? extends GameMasterActionInterface>>();
