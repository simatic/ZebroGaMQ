...
echo "1/ Start the Master application on your Web browser"
echo "2/ Start the Spectator application on your Web browser"
echo "3/ (Optional) Start the PlayerMasterApplication on an Android Device,"
