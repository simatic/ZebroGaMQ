...
import net.totem.gamelogic.spectator.SpectatorActionInterface;
...
public enum MyListOfGameLogicActions {
	...
	private Map<String, ? extends SpectatorActionInterface> actionMap;
	private static List<Map<String, ? extends SpectatorActionInterface>> privateListOfActionsMaps = new Vector<Map<String, ? extends SpectatorActionInterface>>();
	
	public final static List<Map<String, ? extends SpectatorActionInterface>> ListOfActionsMaps = Collections.unmodifiableList(privateListOfActionsMaps);
