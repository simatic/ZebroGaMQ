...
CLASS=zebrogamq.perf.j2se.GameLogicApplication
...
if [[ -f ./target/zebrogamq-gamelogic-perf-application-${MODULE_VERSION}.jar ]]
then
    export JARS=./target/zebrogamq-gamelogic-perf-application-${MODULE_VERSION}.jar:${JARS}
else
