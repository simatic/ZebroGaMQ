...
class RabbitMQGameInstanceChannel {
	...
	RabbitMQGameInstanceChannel(final ChannelsManager channelsManager, final GameLogicState state) throws java.io.IOException {
	...
	private void handleRetryNumber(int retryNumber, int maxRetryNumber, final GameLogicState state){
	...
	private void updateNumberOfRetries(int retryNumber, final GameLogicState state){
		synchronized (state) {
